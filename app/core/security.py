...
# Use bcrypt instead of deprecated pbkdf2_sha256
...
def create_jwt_token(
    ...
    if expire:
        expire_time = current_datetime + timedelta(minutes=expire)
    elif refresh:
        expire_time = current_datetime + timedelta(minutes=settings.REFRESH_TOKEN_EXPIRE_MINUTES)
    else:
        expire_time = current_datetime + timedelta(minutes=settings.ACCESS_TOKEN_EXPIRE_MINUTES)
